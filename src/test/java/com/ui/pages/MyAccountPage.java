...
public class MyAccountPage extends BrowserUtility {
	...
	private static final By SEARCH_PRODUCT_LOCATOR=By.id("search_query_top");
	...
	public SearchResultPage searchForAProduct(String productName) {
		enterText(SEARCH_PRODUCT_LOCATOR, productName);
		enterSpecialKey(SEARCH_PRODUCT_LOCATOR, Keys.ENTER);
